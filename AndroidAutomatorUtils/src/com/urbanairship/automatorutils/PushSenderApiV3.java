...
public class PushSenderApiV3 {
    ...
    public PushSenderApiV3(String masterSecret, String appKey) {
        this(masterSecret, appKey, PUSH_URL);
    }
     ...
     */
    protected PushSenderApiV3(String masterSecret, String appKey, String pushUrl) {
     ...
     * @param pushString The string to append based on the type of push (apid, alias, tag)
    ...
    protected String createMessage(String pushString, Map<String, String> extras, String uniqueAlertId) {
        ...
        Log.i(TAG, "PushSender API v3 string is: " + builder.toString());
    ...
    public String sendPushMessage() throws Exception {
        ...
        return sendUnicastMessage("\"audience\": \"all\",", null);
    }
    ...
    public String sendPushMessage(Map<String, String> extras) throws Exception {
        ...
        return sendUnicastMessage("\"audience\": \"all\",",extras);
    }
    ...
    public String sendPushToTag(String tag) throws Exception {
        ...
        return sendUnicastMessage("\"audience\": { \"tag\": \"" + tag + "\" },", null);
    }
    ...
    public String sendPushToAlias(String alias) throws Exception {
        ...
        return sendUnicastMessage("\"audience\": { \"alias\": \"" + alias + "\" },", null);
    }
    ...
    public String sendPushToApid(String apid) throws Exception {
        ...
        return sendUnicastMessage("\"audience\": { \"apid\": \"" + apid + "\" },", null);
    }

    /**
     * Sends a unicast message
     * @param pushString The audience string
     * @param extras Any notification extras
     * @return A unique alert Id
     * @throws Exception
     */
